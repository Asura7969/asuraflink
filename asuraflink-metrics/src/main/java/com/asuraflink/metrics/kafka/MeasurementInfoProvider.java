...
class MeasurementInfoProvider implements MetricInfoProvider<KafkaMeasurementInfo> {
	@VisibleForTesting
	...
	@Override
	public KafkaMeasurementInfo getMetricInfo(String metricName, MetricGroup group) {
		return new KafkaMeasurementInfo(getScopedName(metricName, group), getTags(group));
	}
